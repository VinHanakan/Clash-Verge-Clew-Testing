...
!if "${BUNDLEID}" == "app.clashvergeclew.desktop.internal-test"
  !define CLEW_INTERNAL_TEST
!else
  !error "The standalone Clash Verge Clew installer is disabled until the inherited service and uninstall paths are isolated."
!endif
