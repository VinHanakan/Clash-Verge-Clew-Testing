...
mod app_init {
    ...
    pub fn generate_handlers() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
        tauri::generate_handler![
            ...
            cmd::set_app_proxy_strategy,
            cmd::get_app_proxy_connections,
            cmd::get_app_proxy_process_tree,
            cmd::get_app_proxy_process_detail,
            cmd::get_app_proxy_rules,
            cmd::get_app_proxy_strategy_groups,
            cmd::set_app_proxy_rules,
            cmd::add_app_proxy_rule,
            cmd::remove_app_proxy_rule,
            cmd::toggle_app_proxy_rule,
...
pub fn run() -> std::process::ExitCode {
    ...
    let builder = app_init::setup_plugins(tauri::Builder::default())
        .manage(core::app_proxy::AppProxyManager::default())
        .setup(|app| {
    ...
    mod event_handlers {
        ...
        pub fn handle_ready_resumed(_app_handle: &AppHandle) {
            ...
            if let Some(window) = _app_handle.get_webview_window("main") {
                let _ = window.set_title("Clash Verge Clew");
            }
        }
    ...
    app.run(|app_handle, e| match e {
        ...
        tauri::RunEvent::Exit => {
            let app_proxy = app_handle.state::<core::app_proxy::AppProxyManager>().inner().clone();
            AsyncHandler::block_on(async move {
            let _ = app_proxy.shutdown().await;
