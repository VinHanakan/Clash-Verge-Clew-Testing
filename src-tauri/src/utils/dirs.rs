...
pub static APP_ID: &str = "app.clashvergeclew.desktop.internal-test";
#[cfg(feature = "internal-test")]
pub static BACKUP_DIR: &str = "clash-verge-clew-backup-internal-test";

#[cfg(all(not(feature = "internal-test"), not(feature = "verge-dev")))]
pub static APP_ID: &str = "app.clashvergeclew.desktop";
#[cfg(all(not(feature = "internal-test"), not(feature = "verge-dev")))]
pub static BACKUP_DIR: &str = "clash-verge-clew-backup";

#[cfg(all(not(feature = "internal-test"), feature = "verge-dev"))]
pub static APP_ID: &str = "app.clashvergeclew.desktop.dev";
#[cfg(all(not(feature = "internal-test"), feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "clash-verge-clew-backup-dev";
...
pub fn app_home_dir() -> Result<PathBuf> {
    ...
    if let Some(path) = std::env::var_os("CLASH_VERGE_DEV_APP_HOME") {
...
mod ipc_tests {
    ...
    fn sidecar_ipc_stays_in_the_app_root() {
        ...
        let app_root = Path::new("/home/test/.local/share/app.clashvergeclew.desktop");
...
mod ipc_tests {
    ...
    fn sidecar_ipc_ignores_long_app_root_and_fits_sockaddr_un() -> anyhow::Result<()> {
        let identity = OwnerIdentity::Unix { uid: 501, gid: 20 };
        let app_root =
            Path::new("/Users/support/Library/Application Support/app.clashvergeclew.desktop.dev");
        let path = sidecar_ipc_path_for(app_root, &identity)?;
